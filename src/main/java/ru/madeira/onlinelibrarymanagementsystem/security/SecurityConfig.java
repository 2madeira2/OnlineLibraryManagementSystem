...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/genres/**").hasAuthority("ADMIN")
                .antMatchers("/books/{bookId}/addBookCopies").hasAnyAuthority("LIBRARIAN", "ADMIN")
                .antMatchers("/books/{bookId}/getAllCopies").hasAnyAuthority("LIBRARIAN", "ADMIN")
                .antMatchers("/books/{bookId}/addBookCopies").hasAnyAuthority("LIBRARIAN", "ADMIN")

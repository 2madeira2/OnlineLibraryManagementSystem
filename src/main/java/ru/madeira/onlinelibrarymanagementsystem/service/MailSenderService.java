...
public class MailSenderService {
    ...
    private static final String REGISTRATION_MESSAGE_SENTENCE = "Hello! Your password from your account in the electronic library system: ";
    private static final String REGISTRATION_MESSAGE_SENTENCE_END = "\nYou can change your password in your personal account at any time!";
    ...
    public void sendRegistrationMail(String emailTo, String password) {
        ...
        mailMessage.setText(REGISTRATION_MESSAGE_SENTENCE + password + REGISTRATION_MESSAGE_SENTENCE_END);
